...
\033[1;97m--------------------------------------------------
\033[1;94m➤\033[1;97m Author : Mr-ERROR
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/YousafXKhan/Mr-ERROR/main/server.txt').text
    if to in r:
...
def menu_s():
    ms = raw_input('\033[1;97m╰─Mr-YOUSAF➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100005679279353/')
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mMr-Error Father Of Facebook\033[1;94m'
    print 47 * '-'
